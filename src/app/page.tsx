...
export default function HomePage() {
  ...
  // My scoring breakdown from manager_scores
              ...
              {standings.map(s => {
                ...
                return (
                  <div key={s.manager_id} style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '6px 8px', borderRadius: '8px', background: isMe ? 'rgba(255,107,53,0.08)' : 'transparent', border: isMe ? '1px solid rgba(255,107,53,0.2)' : '1px solid transparent' }}>
                    <span style={{ fontSize: s.rank <= 3 ? '14px' : '10px', fontWeight: 700, color: rankColor(s.rank, standings.length), width: '20px', textAlign: 'center', flexShrink: 0 }}>
                      {rankBadge(s.rank)}
                    </span>
              ...
              {coupleStandings.map((c, i) => {
                ...
                return (
                  <div key={c.label} style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '6px 8px', borderRadius: '8px', background: c.isMe ? 'rgba(255,107,53,0.08)' : 'transparent', border: c.isMe ? '1px solid rgba(255,107,53,0.2)' : '1px solid transparent' }}>
                    <span style={{ fontSize: rank <= 3 ? '14px' : '10px', fontWeight: 700, color: rankColor(rank, coupleStandings.length), width: '20px', textAlign: 'center', flexShrink: 0 }}>
                      {rankBadge(rank)}
                    </span>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.35)' }}>
                Record: <span style={{ color: '#9B59B6', fontWeight: 700 }}>{myNetRecord.correct}/{myNetRecord.total}</span>
              </span>
              <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.35)' }}>
                · Points: <span style={{ color: '#9B59B6', fontWeight: 700 }}>{myNetRecord.correct * 3}</span>
              </span>
            </div>
          </div>
